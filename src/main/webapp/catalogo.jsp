...
<head>
    ...
    <title>${not empty categoriaNombre ? categoriaNombre : 'Catálogo'} - WEBIA STORE</title>
    
    <!-- FontAwesome y tus estilos principales -->
...
<!-- carita -->
    ...
    <div class="catalog-hero-content">
        <h1 class="catalog-hero-title">
            ${not empty categoriaNombre ? categoriaNombre : 'Nuestros Productos'}
        </h1>
        <p class="catalog-hero-subtitle">
            Colecciones exclusivas · Envíos a todo el Perú
        </p>
    </div>
</section>
    ...
    <main class="catalog-container">
        ...
        <!-- Cabecera estilo Satori / captura -->
        <div class="catalog-header">
         
            <div class="catalog-badge">
                <span>${totalProductos != null ? totalProductos : 0} Productos disponibles</span>
            </div>
        </div>

        <!-- Grid para listar productos -->
